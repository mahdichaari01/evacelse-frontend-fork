...
export const EvalsListContainer = (props: PropsWithChildren) => (
	<div className="col-start-1 row-start-2 row-end-3 lg:row-start-1 lg:row-end-2 2xl:row-end-3">
		{props.children}
	</div>
);

export const QuestionListContainer = (props: PropsWithChildren) => (
	<div className="col-start-2 col-end-4 row-start-2 row-end-3 lg:row-start-2 lg:row-end-3 lg:col-start-1 lg:col-end-2 2xl:row-start-1 2xl:row-end-3 2xl:col-start-3 2xl:col-end-4	">
		{props.children}
	</div>
);
